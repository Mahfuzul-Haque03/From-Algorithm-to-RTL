module {
  ...
  func.func @forward(%arg0: memref<48x64xf32>, %arg1: memref<48x64xf32>, %arg2: memref<48xf32>, %arg3: memref<4x48xf32>, %arg4: memref<4xf32>) -> memref<48x4xf32> attributes {itypes = "_____", otypes = "_"} {
    %0 = call @linear2d_0(%arg0, %arg1, %arg2) {name = "l1"} : (memref<48x64xf32>, memref<48x64xf32>, memref<48xf32>) -> memref<48x48xf32>
    %1 = call @relu2d_0(%0) {name = "relu"} : (memref<48x48xf32>) -> memref<48x48xf32>
    %2 = call @linear2d_1(%1, %arg3, %arg4) {name = "l2"} : (memref<48x48xf32>, memref<4x48xf32>, memref<4xf32>) -> memref<48x4xf32>
    return %2 : memref<48x4xf32>
  }
}
