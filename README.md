...
- Some directories include backup or duplicate files (`*.bak`, backup Vivado logs).
- Folder names and filenames are preserved from experiment runs (including original spelling).
- Artifacts in `Reports/All sv from remote/` contain collected external/generated variants used in comparison.
