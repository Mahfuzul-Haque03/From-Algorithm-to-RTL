...
# 3)Generate calyx IR
$CIRCT_BIN_DIR/hlstool --calyx-hw  --output-level=core --top-level-function=$TOP_FUNC --ir --allow-unregistered-dialects $OUT_DIR/2.${FILE_NAME}-scf-flat.mlir -o 3.${FILE_NAME}-calyx.mlir
...
calyx -l ~/calyx -b verilog 4.${FILE_NAME}.futil -p all > $VERILOG_OUT
